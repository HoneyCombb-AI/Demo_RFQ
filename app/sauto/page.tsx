...
export const metadata = {
  title: "SA Auto Reports | RFQ Viewer",
}

export default async function SautoReportsListPage() {
  const parts = await getPartsList("sauto")
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        {parts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {parts.map((part) => (
              <Link key={part.slug} href={`/sauto/${part.slug}`} className="block group">
