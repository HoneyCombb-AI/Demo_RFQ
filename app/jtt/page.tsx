...
export const metadata = {
  title: "All Reports | JTT RFQ Viewer",
}

export default async function JttReportsListPage() {
  const parts = await getPartsList("jtt")
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        {parts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {parts.map((part) => (
              <Link key={part.slug} href={`/jtt/${part.slug}`} className="block group">
